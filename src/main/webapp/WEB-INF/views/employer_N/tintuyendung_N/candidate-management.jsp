						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="/employer/profile_employer">Thông
									tin cá nhân</a> <a class="dropdown-item" href="/employer/recruitment-management">Tin tuyển
									dụng đã đăng</a> <a class="dropdown-item" href="#">Xem ứng viên
									đã ứng tuyển</a> <a class="dropdown-item"
		...
		<div class="collapse navbar-collapse container" id="navbarNava">
			<ul class="navbar-nav nav-recuitment-li">
				...
				<li class="nav-item"><a class="nav-link" href="/employer/recruitment-management">Tin tuyển
						dụng đã đăng</a></li>
				<li class="nav-item"><a class="nav-link" href="#">Xem ứng
						viên đã ứng tuyển</a></li>
				</li>
				<li class="nav-item"><a class="nav-link" href="/employer/change-password-employer">Đổi mật khẩu</a></li>
			</ul>
			<ul class="rec-nav-right">
			<li class="nav-item"><a class="nav-link" href="/employer/JobPosting">Đăng tin</a></li>
			...
			<div class="row">
				<div class="col-md-8 col-sm-12 col-12 recuitment-inner">
					...
					<div class="rightbottomsmallsection">
						...
						<form action="/employer/candidate-management"
							class="viewjobform form-inline mb-4">
							<label for="keywords" class="mr-2">Tìm kiếm:</label> 
							<input type="text" name="keyword" id="keywords"
								class="form-control mr-2"
								placeholder="Vui lòng thông tin cần tìm">
								<input type="date" name="date" class="form-control mr-2" placeholder="Vui lòng nhập ngày nộp CV">
							<button class="btn btn-primary" type="submit" formaction="">Tìm</button>
						</form>
						<table class="applicantTable admintable table">
							...
							<c:forEach items="${cvs}" var="cv">
								<tr>
									<td>${cv.applicant.fullname}</td>
									<td>${cv.jobPosting.jobTitle}</td>
									<td>${cv.creationDate}</td>
									<td>${cv.pdffile}</td>
									<td><a href="${pageContext.request.contextPath}/employer/view_cv?id=${cv.id}">Xem CV</a></td>
								</tr>
							</c:forEach>
