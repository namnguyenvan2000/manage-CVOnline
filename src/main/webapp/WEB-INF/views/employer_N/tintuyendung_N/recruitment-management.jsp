						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="/employer/profile_employer">Thông
									tin cá nhân</a> <a class="dropdown-item" href="#">Tin tuyển
									dụng đã đăng</a> <a class="dropdown-item"
	...
	<nav class="navbar navbar-expand-lg navbar-light nav-recuitment">
		...
		<div class="collapse navbar-collapse container" id="navbarNava">
			<ul class="navbar-nav nav-recuitment-li">
				...
				<li class="nav-item"><a class="nav-link" href="#">Tin tuyển
						dụng đã đăng</a></li>
			...
			<div class="row">
				<div class="col-md-8 col-sm-12 col-12 recuitment-inner">
					...
					<div class="rightbottomsmallsection">
						<h3 class="mb-4">Quản lý tin đăng tuyển</h3>
						<form action="/employer/recruitment-management"
							class="viewjobform form-inline mb-4">
							<label for="keywords" class="mr-2">Tìm kiếm:</label> <input
						...
						<table class="applicantTable admintable table">
							...
							<c:forEach items="${JobPostingList}" var="jobposting">
								<tr>
									...
									<c:choose>
										<c:when test="${jobposting.status == 'Đủ số lượng'}">
											<td><a href="./recruitment-detail?id=${jobposting.id }"
												class="btn btn-info btn-sm">Chi tiết</a></td>
											<td></td>
											<td></td>
										</c:when>
										<c:when test="${jobposting.status == 'Hết hạn'}">
											<td><a href="./recruitment-detail?id=${jobposting.id }"
												class="btn btn-info btn-sm">Chi tiết</a></td>
											<td></td>
											<td></td>
										...
										<c:otherwise>
											...
											<td><a class="btn btn-info btn-sm"
												href="/employer/recruitment-management/filled?id=${jobposting.id}">Đủ
													số lượng</a></td>
											<td><a href="/employer/recruitment-management/delete?id=${jobposting.id}" class="btn btn-info btn-sm" href="">Xóa</a></td>
										</c:otherwise>
									</c:choose>
								</tr>
							</c:forEach>
