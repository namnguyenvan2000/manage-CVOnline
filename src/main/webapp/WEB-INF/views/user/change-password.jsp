					...
					<ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a class="dropdown-item" href="/user/profile-user">Thông tin
									cá nhân</a> <a class="dropdown-item" href="/user/CV">Xem CV</a> <a
		...
		<div class="collapse navbar-collapse container" id="navbarNava">
			<ul class="navbar-nav nav-recuitment-li">
				<li class="nav-item active"><a class="nav-link"
					href="/user/profile-user">Thông tin cá nhân</a></li>
				<li class="nav-item"><a class="nav-link" href="/user/CV">Xem
						CV</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/user/CV-applied">Việc làm đã ứng tuyển</a></li>
