					...
					<ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu tdropdown"
								...
								<a  class="dropdown-item" href="/user/profile-user">Thông tin cá nhân</a> <a
	...
	<nav class="navbar navbar-expand-lg navbar-light nav-recuitment">
		...
		<div class="collapse navbar-collapse container" id="navbarNava">
			<ul class="navbar-nav nav-recuitment-li">
				...
				<li class="nav-item"><a class="nav-link" href="#">Việc làm đã ứng tuyển</a></li>
		...
		<div class="container published-recuitment-content">
			<div class="row">
				<div class="col-md-8 col-sm-12 col-12 recuitment-inner">
					<form action="/CV-applied" class="profileinformation">
						<h2>Thông tin hồ sơ</h2>
						<br>
						<div class="profilerow">
							<table class="applicantTable admintable table">
								<tr>
									<th>Tiêu đề tin ứng tuyển</th>
								...
								<c:forEach var="cv" items="${cvs}">
				                    <tr>
				                        ...
				                        <td>${cv.jobPosting.jobLocation}</td>
				                        <td>${cv.jobPosting.employer.namecompany}</td>
				                        <td>${cv.creationDate}</td>
				                        <td>${cv.jobPosting.dealine}</td>
				                        <td>${cv.pdffile}</td>
