		...
		<div class="container published-recuitment-content">
			<div class="row">
				<div class="col-md-8 col-sm-12 col-12 recuitment-inner">
					<form class="recuitment-form" action="/save_Job-posting"
						method="post">
								...
								<div id="collapse4" class="collapse show"
									...
									<div class="card-body recuitment-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<select name="jobType" id="jobType" type="text"
													class="form-control">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label text-right label">Vị
												trí tuyển dụng<span style="color: red" class="pl-2">*</span>
											</label>
											<div class="col-sm-9">
												<select name="jobVacancy" id="jobVacancy" type="text"
													class="form-control" id="jobWorkTime">
													<option selected="selected" value="">Chọn vị trí
														tuyển dụng</option>
