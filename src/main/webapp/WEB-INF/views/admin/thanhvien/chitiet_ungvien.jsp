...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="fixednav">
            ...
            <li><a href="/admin/thanhvien" class="current"><i class="fa-solid fa-user beside"></i> Thành viên</a></li>   
            <li><a href="/admin/thongtin"><i class="fa-solid fa-gear"></i> Cài đặt</a></li>
            <li><a href="/admin/logout"><i class="fa-solid fa-right-from-bracket beside"></i> Đăng xuất</a></li>
        </ul>
    </nav>
        ...
        <div class="rightbottomsection">
            <section class="profilebigbox">
                <div class="profilenav">
                    ...
                    <a href="./chitiet-ungvien/chitiet-hoso"><i class="fa-regular fa-pen-to-square picon"></i> Thông tin hồ sơ</a>
                    <a href="./chitiet-ungvien/chitiet-giaoduc-chungchi"><i class="fa-solid fa-book-open picon"></i> Học vấn & Chứng chỉ</a>
                    <a href="./chitiet-ungvien/chitiet-kynang"><i class="fa-regular fa-file picon"></i>Kỹ năng</a>
                    <a href="./chitiet-ungvien/chitiet-kinhnghiem"><i class="fa-solid fa-building-columns picon"></i> Kinh nghiệm</a>
                </div>
            </section>
        </div>
    </section>
