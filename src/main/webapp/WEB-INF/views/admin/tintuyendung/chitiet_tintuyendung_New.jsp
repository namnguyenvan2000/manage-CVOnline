...
<body>
    ...
    <nav class="navbar">
		...
		<ul class="fixednav">
			...
			<li><a href="/admin/tintuyendung" class="current"><i
                ...
                <section class="vacancydetailbigbox">
                    <div class="vacancydetailleftbox">
                        <div class="vacancydetaillefttopbox">
                            <img src="/admin/Images/logo_fpt.png" alt="">
                            <div class="vacancydetaillefttoprightbox">
                                <h4>Tiêu đề tuyển dụng job_title <strong><i class="fa-solid fa-circle-check"></i></strong></h4>
                            </div>
                        </div>
                    ...
                    <div class="vacancydetailrightbox">
                        ...
                        <div class="vacancydetailrightrow">
                            ...
                            <div class="vacancydetailrightrowright">
                                <h4>ĐỊA CHỈ</h4>
                                <span>Tòa nhà FPT, số 10 Phạm Văn Bạch, phường Dịch Vọng, quận Cầu Giấy, Thành phố Hà Nội, Việt Nam.</span>
                            </div>
                        </div>
                        <div class="vacancydetailrightrow">
                            <div class="vacancydetailrightrowleft">
                        ...
                        <div class="vacancydetailrightrow">
                            ...
                            <div class="vacancydetailrightrowright">
                                <h4>Website</h4>
                                <span><a href="https://fptsoftware.com/" target="_blank">https://fptsoftware.com/</a></span>
                            </div>
                        </div>
                    </div>
                </section>
