    ...
    <section class="rightsection">
        ...
        <div class="rightbottomsection">
            <div class="rightbottomsmallsection">
                ...
                <form action="/admin/tintuyendung" class="viewjobform" method="get">
   					<span>Tìm kiếm: </span>
                ...
                <table class="admintable">
                    ...
                    <c:forEach var="job" items="${jobs_posting}">
                        <tr>
                            <td>${job.id}</td>
							<td>${job.jobTitle}</td>
							<td>${job.majorName}</td>
							...
							<td>${job.dealine}</td>
							<td>${job.status}</td>
                            <td><a href="./tintuyendung/chitiet-tintuyendung?id=${job.id}"><i class="fa-solid fa-circle-info"></i></a></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
